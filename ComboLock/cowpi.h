...
e:  digitalWrite(4, a == 0 ? LOW : HIGH);
    ...
    switch(c = !digitalRead(b) * (b + 256 * a + 1024)) {
      case 00000: if ((a = ((a + 1) & 0x3)) || (++b < 18)) goto e;   else break;         
      case 02016: case 02017: case 02020:             d =     c - 001735; break;
      case 02416: case 02417: case 02420:             d =     c - 002332; break;
      case 03016: case 03017: case 03020:             d =     c - 002727; break;
      case 02021: case 02421: case 03021: case 03421: d =     a + 000101; break;
      case 03416: case 03417:                         d = 6 * c - 025052; break;
...
inline void cowpi_sendDataToMax7219(uint8_t address, uint8_t value) {
  ...
  // value is the bit pattern to place in the register
    digitalWrite(10, LOW);
    shiftOut(11, 13, MSBFIRST, address);
    shiftOut(11, 13, MSBFIRST, value);
    digitalWrite(10, HIGH); 
}
